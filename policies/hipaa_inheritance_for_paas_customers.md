...
| **Administrative Controls** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
...
| **Physical Safeguards** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
...
| **Technical Safeguards** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
...
| **Organizational Requirements** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
...
| **Policies and Procedures and Documentation Requirements** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
...
| **HITECH Act - Security Provisions** HIPAA Rule | {{ company }} Control | Inherited
--- | --- | ---
