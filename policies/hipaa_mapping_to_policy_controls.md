...
| **Administrative Controls** HIPAA Rule | {{ company }} Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | {{ company }} Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | {{ company }} Control
---------------- | ----------------
...
| **Organizational Requirements** HIPAA Rule | {{ company }} Control
--- | ---
Business Associate Contracts or Other Arrangements - 164.314(a)(1)(i) | Business Associate Agreements and 3rd Parties Policies

| **Policies and Procedures and Documentation Requirements** HIPAA Rule | {{ company }} Control
--- | ---
