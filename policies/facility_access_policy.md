...
All Pact PHI is stored on Media located in a facility maintained by {{ company }}, a service provider, and its subcontractors.  {{ company }} has signed a BAA with Pact committing to the policy below.

#TODO - complete workstation policy
...
#This is not true, problem?
	* All workstations purchased by {{ company }} are the property of {{ company }} and are distributed to users by the company.