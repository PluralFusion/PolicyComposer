...
Access to Pact systems and application is limited for all users, including but not limited to workforce members, volunteers, business associates, contracted providers, consultants, and any other entity, is allowable only on a minimum necessary basis. All users are responsible for reporting an incident of unauthorized user or access of the organization’s information systems. These safeguards have been established to address the HIPAA Security regulations including the following:
...
* Requests for access to Pact Platform systems and applications is made formally to the VP of Engineering, Privacy Officer, or Security Officer.
* Access is not granted until receipt, review, and approval by the Pact Security Officer;
* The request for access is retained for future reference.
* All access to Pact systems and services are reviewed and updated on an bi-annual basis to assure proper authorizations are in place commiserate with job functions. The form used to conduct account review is [here](https://docs.google.com/a/{{ company }}.io/forms/d/1oeejMta4XLiUsdH2gTKQ-glec6DBiwPJoY9F60HmPWk/viewform).
* Any Pact workforce member can request change of access using this [form](https://docs.google.com/a/{{ company }}.io/forms/d/1ySICzCyEEdNqxHHErjlJqREBijwxs9z72L-rWXrxkm0/viewform).
...
* Generic accounts are not allowed on Pact workstations with access to ePHI.
...
* Pact maintains a minimum necessary approach to access to Customer data. As such, all workforce members do not readily have access to any ePHI without requested access.
...
* Access to Pact systems, applications, and workstations is controlled by requiring unique User Login ID’s and passwords for each individual user and developer.
...
* Shared accounts are not allowed for Pact systems or networks.
...
All workstations at Pact permitted to access ePHI are company owned, and all are laptop Apple products running Mac operating system.
...
Pact does not use paper records for any sensitive information. Use of paper for recording and storing sensitive data is against Pact policies.

## Password Management

* User IDs and passwords are used to control access to Pact systems and may not be disclosed to anyone for any reason.
...
* On all production systems and application in the Pact environment, password configurations are set to require that passwords are a minimum of 8 character length, 90 day password expiration, account lockout after 5 invalid attempts, password history of last 4 passwords remembered, and account lockout after 15 minutes of inactivity.
...
## Pact Access to {{ company }} Systems
